          ...
          <div className="w-full">
            ...
            >
              ...
              <button
                type="submit"
                name="register"
                className="w-full px-6 py-2 bg-indigo-600 text-white poppins text-xl leading-tight uppercase rounded shadow-md"
              >
                Update Movie
              </button>
            </form>
